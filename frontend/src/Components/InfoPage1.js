...
const InfoPage1 = () => {
    ...
    return (
        <div className="infopage1 flex flex-col justify-center min-h-screen p-4 mx-60">
            ...
            Imagine a scenario where you’re frustrated by your fridge's lukewarm performance, recalling the nightmare that began three weeks ago when it suddenly stopped cooling entirely. A repair person offered a temporary fix, but the chill soon vanished again, and the problem resurfaced.
            </p>
            <p className="text-2xl mb-4 leading-relaxed">
            After a thorough inspection, the inevitable was confirmed: you need a new fridge now and decide to buy a new one. Fortunately, your search led you to a selection of refrigerators that are in your budget.
            </p>
            <p className='text-2xl mb-4 leading-relaxed'>
